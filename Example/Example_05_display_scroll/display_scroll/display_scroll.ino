...
//LCDWIKI_SPI my_lcd(ST7735S,A5,A3,-1,A2,A4,A1);//software spi,model,cs,cd,miso,mosi,reset,clk

//if the IC model is not known and the modules is readable,you can use this constructed function
//LCDWIKI_SPI my_lcd(160,128,A5,A3,-1,A2,A4,A1);//software spi,model,cs,cd,miso,mosi,reset,clk

//the definiens of hardware spi mode as follow:
//if the IC model is known or the modules is unreadable,you can use this constructed function
//LCDWIKI_SPI my_lcd(ST7735S,10,9,8); //hardware spi,cs,cd,reset

//if the IC model is not known and the modules is readable,you can use this constructed function
//LCDWIKI_SPI my_lcd(160,128,10,9,8); //hardware spi,cs,cd,reset
